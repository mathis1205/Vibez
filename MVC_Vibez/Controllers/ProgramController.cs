...
namespace MVC_Vibez.Controllers
{
    public class ProgramController : Controller
    {
        ...
        public ProgramController(LoginService loginService)
        {
        ...
        {
            return View(new ProgramPage { user = _LoginService.GetUserByEmail(User.Identity.Name) });
        }
        ...
        [HttpPost]
        public async Task<IActionResult> AddToFavoriteAsync(PlaylistsItem song)
        {
            try
            {
                await SearchHelper.AddTrackToPlaylistAsync(song.Uri);
